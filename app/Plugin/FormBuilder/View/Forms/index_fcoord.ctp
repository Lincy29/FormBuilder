...
<div class="roles index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit_fadmin', $form['Form']['id'])); ?>
			<?php 
			if($form['Form']['recstatus'] == 1){
				echo $this->Form->postLink(__('', true), array('action' => 'deactivate_fcoord_form', $form['Form']['id']),array('class' => 'glyphicon glyphicon-remove', 'escape' => false), null, __('Are you sure you want to Deactivate # %s?', $form['Form']['id'])); 
			}
		?>
		</td>
	</tr>
